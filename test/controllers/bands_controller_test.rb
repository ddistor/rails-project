...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { area: @band.area, disbanded: @band.disbanded, founded: @band.founded, name: @band.name } }
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { area: @band.area, disbanded: @band.disbanded, founded: @band.founded, name: @band.name } }
